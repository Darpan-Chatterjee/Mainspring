...
public class UserStoryCreationPageTest extends BaseTest {
	...
	@BeforeClass
	public void UserStoryCreationTestScenarioSetup()
	{
		scenario = ExtentReportManager.createScenario("User Story Creation Scenarios","");
